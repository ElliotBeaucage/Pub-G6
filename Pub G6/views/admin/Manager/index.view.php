...
<body>
    <div class="index">
        ...
        <div class="quote">
            ...
            <a class=" btn-gap" href="propos-manager">Notre histoire</a>
        </div>

        <div class="menu">
            <a href="menus-manager" class=" flex">
                <div class="appetizer" onmouseover="showTexte()" onmouseout="UnShowTexte()"></div>
            </a>
            <a href="menus-manager" class=" flex">
            ...
            <a href="menus-manager" class=" flex">
                <div class="dessert " onmouseover="showTexte()" onmouseout="UnShowTexte()"></div>
            </a>
        </div>
    ...
    <div class="index2">
        <div class="index2-nav">
            <a href="index-gestionnaire">Accueil</a>
            <a href="menus-gestionnaire">Menus</a>
            <a href="propos-gestionnaire">Propos</a>
