...
<body>
    <div class="index">
        ...
        <div class="quote">
            ...
            <a class="button" href="propos-user">Notre histoire</a>
        </div>
        <main>
        <div class="menu">
               <a href="menus-user" class=" flex"><div class="appetizer" onmouseover="showTexte()" onmouseout="UnShowTexte()"></div></a>
                <a href="menus-user" class=" flex">
                ...
                <a href="menus-user" class=" flex"><div class="dessert " onmouseover="showTexte()" onmouseout="UnShowTexte()"></div></a>
        </div>
        </main>
        <div class="comms">   
            <div class="comm">
